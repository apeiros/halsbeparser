  ...
  suite 'primary literals' do
    {
      ...
      :float => [
        %w[1e0 +1e0 -1e0 1e+1 1e-1 +1e+1 +1e-1 -1e+1 -1e-1], # there's more, *sob*
        %w[]
      ],
      :date => [
      ...
      :time => [
        %w[12:00 12:34:56 12:34:56.789], # timezones...
        %w[]
      ],
      :date_time => [
        %w[2010-01-01T12:34 2010-01-01T12:34 2010-01-01T12:34:56 2010-01-01T12:34:56.789],
        %w[]
      ],
